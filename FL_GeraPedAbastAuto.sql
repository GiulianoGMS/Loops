    ...
    LOOP
     ...
     -- FECHA OS LOTES
      ...
      -- INSERE NA TABELA DE LOG SE O LOTE FOI GERADO COM SUCESSO
         INSERT INTO CONSINCO.NAGT_LOGGERAABASTAUTO VALUES (T.SEQGERCOMPRA, SYSDATE, 'JOBABASTAUTO', 'GERADO', 'ABASTECIMENTO');
      ...
      -- INSERE NA TABELA DE LOG SE OCORRER ERRO AO GERAR
         INSERT INTO CONSINCO.NAGT_LOGGERAABASTAUTO VALUES (T.SEQGERCOMPRA, SYSDATE, 'JOBABASTAUTO', 'ERRO', 'ABASTECIMENTO');
         COMMIT;
