CREATE TABLE NAGT_BASE_EXCLUSAO_CAMP (CODPRODUTO NUMBER(20));

-- Backup

SELECT * FROM NAGT_BASE_EXCLUSAO_CAMP FOR UPDATE;
...
SELECT DISTINCT X.SEQPRODUTO
 ...
 SELECT * FROM MAP_PRODCODIGO X WHERE CODACESSO LIKE '%75496002005%'
